...
const IconFlagUnitedKingdom = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg
        ...
        >
            ...
            <path
                fill="#cf1b2b"
                d="m25.14 23l9.712 6.801a3.977 3.977 0 0 0 .99-1.749L28.627 23zM13 23h-2.141l-9.711 6.8c.521.53 1.189.909 1.938 1.085L13 23.943zm10-10h2.141l9.711-6.8a3.988 3.988 0 0 0-1.937-1.085L23 12.057zm-12.141 0L1.148 6.2a3.994 3.994 0 0 0-.991 1.749L7.372 13z"
            ></path>
            <path
                fill="#eee"
...
export default IconFlagUnitedKingdom;
